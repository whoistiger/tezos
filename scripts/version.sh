...
export full_opam_repository_tag=8beae05aa76907a8ad832633c7f9a43d7d4ff2f9

## opam_repository is an additional, tezos-specific opam repository.
## This value MUST be the same as `build_deps_image_version` in `.gitlab/ci/templates.yml
export opam_repository_url=https://gitlab.com/nomadic-labs/opam-repository
export opam_repository_tag=abfd058729a03d7104a35f46c366696d9b64f4dd
